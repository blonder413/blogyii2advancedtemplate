...
<section class="posts col-md-9">
        ...
        <p class="text-center">
            ...
            Modal::begin([
                'header' => Html::img(
                    '@web/img/foto.jpg',
                        [
                            'alt'           => 'Mi Nombre Completo',
                            'title'         => 'Mi Nombre Completo',
                        ]
                    ),
                'toggleButton' =>   ['label' => 
                                        Html::img(
    ...
    <ul class="list-style-none">
        <li>
            <a href="http://aptana.com/" title="Aptana Studio" target="_blank">
                Aptana Studio
            </a>
        </li>
        <li>
            <a href="http://www.eclipse.org/" title="Eclipse" target="_blank">
                Eclipse
            </a>
        </li>
        <li>
            <a href="https://netbeans.org/" title="Netbeans" target="_blank">
                Netbeans
            </a>
        </li>
        <li>
        ...
        <li>
            <a href="http://bluefish.openoffice.nl/index.html" title="bluefish" target="_blank">
                BlueFish
            </a>
        </li>
        <li>
        ...
        <li>
            <a href="http://www.chromium.org/Home" title="Chromium" target="_blank">
                Chromium
            </a>
        </li>
        <li>
            <a href="https://www.google.com/chrome?hl=es" title="Chrome" target="_blank">
                Google Chrome
            </a>
        </li>
        <li>
        ...
        <li>
            <a href="http://www.videolan.org/" title="VLC" target="_blank">
                VLC
            </a>
        </li>
        <li>
            <a href="http://projects.gnome.org/gedit/" title="Gedit" target="_blank">
                Gedit
            </a>
        </li>
        <li>
        ...
        <li>
            <a href="http://windows.microsoft.com/es-ES/internet-explorer/products/ie/home" title="Internet Explorer" target="_blank">
                Internet Explorer
            </a>
        </li>
    </ul>
